...
class PromptBuilder
{
    ...
    public function build(): string
    {
        ...
        return <<<PROMPT
            ...
            - Si read_entity_content signale code_mode=false (theme visuel/MJML) et que la demande est une petite retouche ponctuelle (remplacer une URL de logo, corriger une date...), n abandonne pas et ne dis jamais que c est impossible via l API : utilise replace_entity_content_text(type, id, search, replace) a la place d update_entity_content. Il fonctionne quel que soit le mode et synchronise la source MJML si elle existe. Reserve update_entity_content (remplacement integral) au mode code source.
